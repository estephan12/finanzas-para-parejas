                ...
                <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
                    <div className="flex justify-between h-16">
                        <div className="flex items-center">
                            ...
                            <h1 className="text-xl font-bold text-gray-900">Metas de Ahorro</h1>
                        </div>
                    </div>
                </div>
            </nav>
                ...
                <div className="grid grid-cols-1 lg:grid-cols-3 gap-8">
                    ...
                    <div className="lg:hidden mb-4">
                        <button
                            ...
                            className="w-full btn-primary flex items-center justify-center space-x-2 bg-purple-600"
                        >
                    ...
                    {showAddModal && (
                        <div className="lg:hidden fixed inset-0 z-50 flex items-end sm:items-center justify-center bg-black bg-opacity-50 p-4">
                            <div className="w-full max-w-md bg-white rounded-xl overflow-hidden">
                                ...
                                <GoalForm onClose={() => setShowAddModal(false)} />
                            </div>
                        </div>
                    )}
